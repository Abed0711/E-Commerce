...
public class SettinsActivity extends AppCompatActivity {
    ...
    private void UpdateOnlyUserInfo() {
        ...
        useMap.put("name", fullNameEditText.getText().toString());
        useMap.put("address", addressEditText.getText().toString());
        useMap.put("phoneOrder", userPhoneEditText.getText().toString());
        ...
        Toast.makeText(SettinsActivity.this, "Profile InfoUpdate successfully..", Toast.LENGTH_SHORT).show();
        finish();
